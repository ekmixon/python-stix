...
class STIXType(GeneratedsSuper):
    ...
    def factory(self, **kwargs_):
        if STIXType.subclass:
            return STIXType.subclass(*self, **kwargs_)
        else:
            return STIXType(*self, **kwargs_)
    ...
    def hasContent_(self):
        return bool(
            (
                self.STIX_Header is not None
                or self.Observables is not None
                or self.Indicators is not None
                or self.TTPs is not None
                or self.Exploit_Targets is not None
                or self.Incidents is not None
                or self.Courses_Of_Action is not None
                or self.Campaigns is not None
                or self.Threat_Actors is not None
...
class RelatedPackagesType(stix_common_binding.GenericRelationshipListType):
    ...
    def __init__(self, scope='exclusive', Related_Package=None):
        ...
        self.Related_Package = [] if Related_Package is None else Related_Package
    def factory(self, **kwargs_):
        if RelatedPackagesType.subclass:
            return RelatedPackagesType.subclass(*self, **kwargs_)
        else:
            return RelatedPackagesType(*self, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        return bool(
            (
                ...
                or super(RelatedPackagesType, self).hasContent_()
            )
        )
...
class RelatedPackageType(stix_common_binding.GenericRelationshipType):
    ...
    def factory(self, **kwargs_):
        if RelatedPackageType.subclass:
            return RelatedPackageType.subclass(*self, **kwargs_)
        else:
            return RelatedPackageType(*self, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        return bool(
            (
                ...
                or super(RelatedPackageType, self).hasContent_()
            )
        )
...
class STIXHeaderType(GeneratedsSuper):
    ...
    def __init__(self, Title=None, Package_Intent=None, Description=None, Short_Description=None, Profiles=None, Handling=None, Information_Source=None):
        self.Title = Title
        self.Package_Intent = [] if Package_Intent is None else Package_Intent
    ...
    def factory(self, **kwargs_):
        if STIXHeaderType.subclass:
            return STIXHeaderType.subclass(*self, **kwargs_)
        else:
            return STIXHeaderType(*self, **kwargs_)
    factory = staticmethod(factory)
...
class IndicatorsType(GeneratedsSuper):
    ...
    def factory(self, **kwargs_):
        if IndicatorsType.subclass:
            return IndicatorsType.subclass(*self, **kwargs_)
        else:
            return IndicatorsType(*self, **kwargs_)
    factory = staticmethod(factory)
...
class TTPsType(GeneratedsSuper):
    ...
    def __init__(self, TTP=None, Kill_Chains=None):
        self.TTP = [] if TTP is None else TTP
        self.Kill_Chains = Kill_Chains
    def factory(self, **kwargs_):
        if TTPsType.subclass:
            return TTPsType.subclass(*self, **kwargs_)
        else:
            return TTPsType(*self, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        return bool((self.TTP or self.Kill_Chains is not None))
...
class IncidentsType(GeneratedsSuper):
    ...
    def factory(self, **kwargs_):
        if IncidentsType.subclass:
            return IncidentsType.subclass(*self, **kwargs_)
        else:
            return IncidentsType(*self, **kwargs_)
    factory = staticmethod(factory)
...
class CoursesOfActionType(GeneratedsSuper):
    ...
    def __init__(self, Course_Of_Action=None):
        self.Course_Of_Action = [] if Course_Of_Action is None else Course_Of_Action
    def factory(self, **kwargs_):
        if CoursesOfActionType.subclass:
            return CoursesOfActionType.subclass(*self, **kwargs_)
        else:
            return CoursesOfActionType(*self, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        return bool(self.Course_Of_Action)
...
class CampaignsType(GeneratedsSuper):
    ...
    def __init__(self, Campaign=None):
        self.Campaign = [] if Campaign is None else Campaign
    def factory(self, **kwargs_):
        if CampaignsType.subclass:
            return CampaignsType.subclass(*self, **kwargs_)
        else:
            return CampaignsType(*self, **kwargs_)
    factory = staticmethod(factory)
...
class ThreatActorsType(GeneratedsSuper):
    ...
    def factory(self, **kwargs_):
        if ThreatActorsType.subclass:
            return ThreatActorsType.subclass(*self, **kwargs_)
        else:
            return ThreatActorsType(*self, **kwargs_)
    factory = staticmethod(factory)
...
class ReportsType(GeneratedsSuper):
    ...
    def factory(self, **kwargs_):
        if ReportsType.subclass:
            return ReportsType.subclass(*self, **kwargs_)
        else:
            return ReportsType(*self, **kwargs_)
    factory = staticmethod(factory)
